...
2.5.2 - 10-10-2025
- Semi final stable revisions to run batch delete and find orphaned image functions.
...
2.4.1 - 10-10-2025
- Restored Cron functions insead of using AJAX. AJAX not working during live testing.
